...
class LadySilviaGreetings {
    ...
    fun greeting(): String {
        ...
        return when(CurrentEvent.eventTitle()) {
            ...
            EventTitle.THIRD_FLOOR_ENDING_EVENT -> "Marvelous! That flea bearer has been finally defeated."
            EventTitle.TEMPLE_EVENT -> "We need to find that damned key to the temple. Keep excavating!"
            ...
            EventTitle.STATUE_EVENT -> "Hmmm... I'm still thinking about that statue.  What should be inserted into those slots?"
