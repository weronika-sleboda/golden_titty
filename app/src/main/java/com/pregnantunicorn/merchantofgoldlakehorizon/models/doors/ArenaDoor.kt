...
class ArenaDoor : Door(
    "Arena",
    "This is the place where you can upgrade your max energy for golden coins.",
    "Closed At Night"
)
{
    ...
    override fun open(activity: FragmentActivity) {
        ...
        CurrentSkillManager.changeSkillManager(CurrentSkillManager.ENERGY)
    ...
    override fun icon(): Int {
        ...
        return IconFactory().arenaDoor128()
    }
}
