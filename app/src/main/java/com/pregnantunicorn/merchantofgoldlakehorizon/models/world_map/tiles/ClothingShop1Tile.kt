...
) : Tile(true)
{
    override fun icon(): Int {
        ...
        return IconFactory().firstClothingShop64()
    }
    ...
    override fun onClick(activity: FragmentActivity) {
        ...
        when(CurrentDayCycle.dayCycle()) {
            ...
            DayCycle.NIGHT -> {
                ...
                CurrentLockedDoor.changeLockedDoor(CurrentLockedDoor.RED_VELVET_DOOR)
                ...
                CurrentDoor.changeDoor(CurrentDoor.RED_VELVET)
