...
import com.pregnantunicorn.merchantofgoldlakehorizon.views.fragments.LibraryFragment
...
class LibraryDoor : Door(
    "Library",
    "This is the place where you can read books in expense of your intelligence points.",
    "Closed At Night"
)
{
    ...
    override fun open(activity: FragmentActivity) {
        ...
        activity.supportFragmentManager.commit {
            ...
            replace<LibraryFragment>(R.id.world_container)
        }
    }

    override fun icon(): Int {

        return IconFactory().libraryDoor128()
    }
}
