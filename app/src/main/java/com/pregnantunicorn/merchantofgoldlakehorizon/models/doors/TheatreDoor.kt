...
class TheatreDoor : Door(
    "Theatre",
    "This is the place where you can upgrade your max persuasion for golden coins.",
    "Closed At Night"
)
{
    ...
    override fun open(activity: FragmentActivity) {
        ...
        CurrentSkillManager.changeSkillManager(CurrentSkillManager.PERSUASION)
    ...
    override fun icon(): Int {
        ...
        return IconFactory().theatreDoor128()
    }
}
